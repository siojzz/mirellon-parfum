...
(function () {
  ...
  const MARKETPLACE_LINKS = {
    shopee: window.MIRELLON_CONFIG?.marketplace?.shopee || "",
    tokopedia: window.MIRELLON_CONFIG?.marketplace?.tokopedia || "",
    tiktok: window.MIRELLON_CONFIG?.marketplace?.tiktok || "",
  };
  ...
  const PRODUCTS = [
    ...
    },
    {
      ...
      middle: "Cinnamon",
      base: "Amber",
      desc: "Aroma hangat yang memikat dengan lapisan rempah dan amber yang kaya.",
    ...
    },
    {
      ...
      middle: "Iris",
      base: "Clean Musk",
      desc: "Aroma bunga dan bedak yang lembut, bersih, dan terasa mewah seperti sentuhan sutra.",
    ...
    },
    {
      ...
      middle: "Night Bloom",
      base: "Patchouli",
      desc: "Pesona bunga malam yang intens dengan rempah dan patchouli yang dewasa.",
    ...
    return `
      <article class="product-card" data-aos="fade-up">
        ...
        <div class="product-body">
          ...
          <div class="rating-row">${starRow(p.rating)}<span class="rating-num">${p.rating.toFixed(1)}</span><span class="rating-count">(${p.reviews})</span></div>
